...
poly1="data/basic/basic_test1_m1.txt"
poly2="data/basic/basic_test1_m2.txt"

vk_output="${base_dir}/results/basic_test1_vk_native.txt"
native_output="${base_dir}/results/basic_test1_optix_native.txt"
