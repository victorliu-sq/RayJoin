...
poly1="data/basic/basic_test2_m1.txt"
poly2="data/basic/basic_test2_m2.txt"

vk_output="${base_dir}/results/basic_test2_vk_native.txt"
native_output="${base_dir}/results/basic_test2_optix_native.txt"
