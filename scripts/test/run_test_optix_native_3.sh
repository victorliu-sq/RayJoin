...
poly1="data/realworld/USACensusBlockGroupBoundaries.cdb"
poly2="data/realworld/USADetailedWaterBodies.cdb"

native_output="${base_dir}/results/Block_Water_result_native.txt"
optix_output="${base_dir}/results/Block_Water_result_optix.txt"
