#ifndef RAYJOIN_SCALING_H
#define RAYJOIN_SCALING_H
...
class Scaling {
 ...
 public:
  ...
  internal_coord_t ScaleY(coord_t y) const {
  ...
  internal_coord_t get_internal_max() const { return internal_max_; }
