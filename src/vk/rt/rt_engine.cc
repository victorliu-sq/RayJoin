...
void RTEngine::Init() {
  ...
  fpCmdCopyAccelerationStructureKHR =
      (PFN_vkCmdCopyAccelerationStructureKHR) vkGetDeviceProcAddr(
          device_, "vkCmdCopyAccelerationStructureKHR");
